...
# [4] 2차원 배열 계산 시간
#----------------------------------------
A 계산 시간(평균/{REPEAT}회): {A_time_2d:.5f} ms
B 계산 시간(평균/{REPEAT}회): {B_time_2d:.5f} ms
총 시간: {(total_time_2d):.5f} ms

#----------------------------------------
# [5] 1차원 배열 계산 시간
#----------------------------------------
A 계산 시간(평균/{REPEAT}회): {A_time_1d:.5f} ms
B 계산 시간(평균/{REPEAT}회): {B_time_1d:.5f} ms
총 시간: {(total_time_1d):.5f} ms
